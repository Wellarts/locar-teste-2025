                                        ...
                                        Grid::make([
                                            ...
                                            ->schema([
                                                ...
                                                Forms\Components\Toggle::make('status_pago_financeiro')
                                                    ->visible(fn(Get $get): bool => $get('status_financeiro'))
                                                    ->disabled(fn(string $context): bool => $context === 'edit')
                                                    ->live()
                                                    ->afterStateUpdated(
                                                        function (Get $get, Set $set, $state) {
                                                ...
                                                Forms\Components\Select::make('proxima_parcela')
                                                    ->visible(fn(Get $get): bool => $get('status_financeiro') && !$get('status_pago_financeiro'))
                                                    ->disabled(fn(string $context): bool => $context === 'edit')
                                                    ->options([
                                                        '7' => 'Semanal',
                                                        '15' => 'Quinzenal',
                                                ...
                                                Forms\Components\Select::make('caixa_id')
                                                    ...
                                                    ->searchable()
                                                    ->preload()
                                                    ->required(fn(Get $get): bool => $get('status_financeiro') && $get('status_pago_financeiro'))
                                                    ->columnSpan([
                                                        'xl' => 2,
                                                        '2xl' => 2,
                                                    ])
